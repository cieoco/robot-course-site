...
pages = {
    ...
    'motor.html': lesson_page('積木程式：讓馬達開始轉', '02 控制 / E10–E13', '從 Blockly 控制器的第一個 PWM 指令，理解出力、方向與馬達個體差異。', '15', ['組出動作', '比較 PWM', '驗證方向', '觀察差異'], 'motor.md', 'program.html', '下一課：Blockly 重複與角度控制'),
    'program.html': lesson_page('Blockly 進階：重複、速度與角度', '02 控制 / 積木進階', '把一次動作排成重複節奏，並開始使用 M3／M4 的回授控制。', '12', ['分清 setup／loop', '組出重複動作', '試速度與角度', '安全存檔'], 'program.md', 'settings.html', '下一步：相關設定與調參'),
